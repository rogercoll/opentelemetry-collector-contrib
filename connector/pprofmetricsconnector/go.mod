module github.com/open-telemetry/opentelemetry-collector-contrib/connector/pprofmetricsconnector
...
require (
	...
	go.opentelemetry.io/collector/connector/xconnector v0.149.0
