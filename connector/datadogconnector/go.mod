...
require (
	...
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/statsprocessor v0.60.0
...
require (
	...
	github.com/DataDog/datadog-agent/comp/otelcol/logsagentpipeline/logsagentpipelineimpl v0.60.0 // indirect
