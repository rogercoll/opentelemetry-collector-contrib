...
func containerStatsToMetrics(ts time.Time, container container, stats *define.ContainerStats) pmetric.Metrics {
...
func appendMemoryMetrics(ms pmetric.MetricSlice, stats *define.ContainerStats, ts pcommon.Timestamp) {
...
func appendNetworkMetrics(ms pmetric.MetricSlice, stats *define.ContainerStats, ts pcommon.Timestamp) {
...
func appendIOMetrics(ms pmetric.MetricSlice, stats *define.ContainerStats, ts pcommon.Timestamp) {
...
func appendCPUMetrics(ms pmetric.MetricSlice, stats *define.ContainerStats, ts pcommon.Timestamp) {
